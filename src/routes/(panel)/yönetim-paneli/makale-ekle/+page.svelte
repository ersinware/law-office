...
<svelte:head>
    <title
        >Makale Ekle | Yönetim Paneli | Mirici & Partners Avukatlık Bürosu | Merkez,
        Çanakkale</title
    >
</svelte:head>

<div
    class="grid page-gap max-w-page m-h-auto small-screen-reverse-p-b-for-bottom-bar-for-page"
...
>
    ...
    <div
        class="b-box last-section panel-full-w wrapper-with-left-menu page-p-v-d secondary-background-color small-screen-p-b-for-bottom-bar-for-page small-screen-p-h-d"
    >
...
<style>
    #add-photo-button {
        color: var(--add-photo-button-color);
    }

    @media (hover: hover) {
        #add-photo-button:hover {
            color: var(--add-photo-button-color-darker);
        }
    }
</style>
