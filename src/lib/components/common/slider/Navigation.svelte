...
{#if loaded}
    {#if _showArrows}
        <button
            id="navigation-arrow-left-wrapper"
            class="p-a"
    ...
    <div
        class="indicators p-a p-c-h flex a-i-c g-dot75"
    ...
    {#if _showArrows}
        <button
            id="navigation-arrow-right-wrapper"
            class="p-a"
...
<style>
    .indicators {
        bottom: calc(var(--main-v-padding) * 1.25);

        width: max-content;
    }

    .indicators,
    #navigation-arrow-left-wrapper,
    #navigation-arrow-right-wrapper {
        z-index: 999999;
    }
