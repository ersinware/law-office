...
>
    <article class="big-grid-component-texts-wrapper flex f-column g-1dot5">
        ...
        <div class="flex f-column g-1dot5">
            <p
                class="small-section-text big-component-text t-a-j {limitedLines
            ...
            {#if href}
                <a
                    ...
                    on:click={(event) =>
                        framedButtonRipple
                            ? onLinkClickForFramedButton(event)
                            : onLinkClick(event)}
                >
                    {buttonText}
                </a>
...
<style>
    .big-grid-component {
        padding: calc(var(--main-v-padding) * 1.125);
    }
