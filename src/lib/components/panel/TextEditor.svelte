...
<Tooltip
    ...
    manual
>
    <div id="editor-icons-wrapper" class="secondary-background-color">
        <article
            id="editor-icons"
        ...
        >
            ...
            >
                <svg
                    ...
                    class:active-editor-icon={$editor?.isActive("heading", {
                        level: 2,
                    })}
            ...
            >
                <svg
                    class="editor-icon b-r-d"
                    class:active-editor-icon={$editor?.isActive("paragraph")}
                    class:disabled-editor-icon={disable}
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                    ><path
            ...
            <button
                on:click={(event) =>
                    onChange(event, () => $editor.chain().toggleItalic().run())}
                disabled={disable}
            >
                <svg
                    class="editor-icon b-r-d"
                    class:active-editor-icon={$editor?.isActive("italic")}
                    class:disabled-editor-icon={disable}
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                    ><path
            ...
            >
                <svg
                    class="editor-icon b-r-d"
                    class:active-editor-icon={$editor?.isActive("underline")}
                    class:disabled-editor-icon={disable}
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                    ><path
            ...
            <button on:click={onLinkClick} disabled={disable}>
                <svg
                    class="editor-icon b-r-d"
                    class:active-editor-icon={$editor?.isActive("link")}
                    class:disabled-editor-icon={disable}
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 640 512"
                    ><path
            ...
            >
                <svg
                    class="editor-icon b-r-d"
                    class:active-editor-icon={$editor?.isActive("bulletList")}
                    class:disabled-editor-icon={disable}
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                    ><path
            ...
            >
                <svg
                    class="editor-icon b-r-d"
                    class:active-editor-icon={$editor?.isActive("orderedList")}
                    class:disabled-editor-icon={disable}
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                    ><path
