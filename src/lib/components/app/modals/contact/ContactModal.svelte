<script>
    ...
    async function onContinue(event) {
        ...
        $holder.thoughts = capitalizeFirstLetterOnly(
            form.querySelector("#thoughts").value,
        );
